    ...
    : ISharedRequestSender
{
    ...
    {
        return await requestSenderPolicy.Policy.ExecuteAsync(() =>
            sprintRequestSender.Send(request));
    }
    ...
    {
        return await requestSenderPolicy.Policy.ExecuteAsync(() =>
            noteTypeRequestSender.Send(request));
    }
    ...
    {
        return await requestSenderPolicy.Policy.ExecuteAsync(() =>
            timerSettingsRequestSender.Send(request));
    }
