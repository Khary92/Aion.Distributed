...
public class ExportService(
    ...
    IDtoMapper<WorkDayDto, WorkDay> workDayMapper)
    : IExportService
{
    ...
    private async Task FillDictionaryForWorkday(WorkDay workDay,
        Dictionary<DateTimeOffset, List<TicketDataHolder>> result)
    {
        var timeSlots = await timeSlotRequestsService.GetTimeSlotsForWorkDayId(workDay.WorkDayId);
