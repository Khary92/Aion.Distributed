...
using TraceReportNotificationService = Core.Server.Communication.Services.TraceReport.TraceReportNotificationService;

namespace Core.Server.Communication.Mock.TraceReport;
