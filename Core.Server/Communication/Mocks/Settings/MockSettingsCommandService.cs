...
using SettingsNotificationService = Core.Server.Communication.Endpoints.Settings.SettingsNotificationService;

namespace Core.Server.Communication.Mocks.Settings;
