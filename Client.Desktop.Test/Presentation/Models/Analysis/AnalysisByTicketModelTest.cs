...
public class AnalysisByTicketModelTest
{
    ...
    public async Task AddTicket()
    {
        ...
        fixture.NotificationPublisher.Ticket.Publish(newTicketMessage);
    ...
    public async Task ClientTicketDataUpdatedNotification()
    {
        ...
        var newTicketClientModel =
            new TicketClientModel(ticketId, ticketName, "bookingNumber", "ChangeDocumentation", []);
        ...
        await fixture.NotificationPublisher.Ticket.Publish(clientTicketDataUpdateNotification);
