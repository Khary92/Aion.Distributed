...
public class ServerTagDataViewModel : ReactiveObject
{
    ...
    public ServerTagDataViewModel(ServerTagDataModel serverTagDataModel)
    {
        DataModel = serverTagDataModel;
    ...
    public ServerTagDataModel DataModel { get; }
