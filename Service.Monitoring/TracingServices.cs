...
public static class TracingServices
{
    ...
    {
        services.AddSingleton<IReportSender>(sp =>
            new ReportSender(sp.GetRequiredService<IGrpcUrlService>().InternalToAdminUrl));
    }
    ...
    private static void AddVerifiers(this IServiceCollection services)
    {
        ...
        services.AddSingleton<IVerificationProvider, ClientVerificationProvider>();
    }
}